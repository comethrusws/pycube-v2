...
export default function ProductCategoriesContent() {
  ...
  const fetchData = async (page: number = 1) => {
    ...
    try {
      ...
      }>(`/api/product-categories/list?${queryParams}`)
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Organize and manage product categorization</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            ...
            <p className="text-2xl font-light text-blue-600">
              {data.filter(item => !item.parentCategoryId).length}
            </p>
          </div>
          <div className="bg-white rounded-lg p-4 border border-gray-200">
                    ...
                    <tr key={category.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <td className="px-4 py-3">
                        {category.parentCategoryName ? (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-900">{category.parentCategoryName}</span>
                          </div>
                        ) : (
                          <span className="text-sm text-gray-500 italic">Root Category</span>
                        )}
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-gray-900">{category.totalProducts}</span>
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <Package className="w-4 h-4 text-gray-400" />
                          <span className="text-sm text-gray-900">{category.totalAssets}</span>
                        </div>
                      </td>
